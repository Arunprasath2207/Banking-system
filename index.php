...
<body>
  <nav>
    <div class="container-fluid nav-wrapper #00838f cyan darken-3 z-depth-5">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li><a href="./php/transactionhistory.php">History</a></li>
      </ul>
    </div>
  </nav>
  ...
  <div class="center head mt-0">
    <h2><b><span><img src="https://www.thesparksfoundationsingapore.org/images/logo_small.png" style="height:70px;width:60px" /></span>ARUN BANK</b></h2>
  </div>
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            ...
            <h5><b>Welcome to ARUN Bank !</b></h5>
            <br />
  ...
  <footer class="center footer">
    <h6 class="info"><b>2021 © Powered by Arunprasath</b></h6>
